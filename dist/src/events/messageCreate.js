    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                cmd = client.commands.get(command) || client.commands.find(function (cmd) { return cmd.aliases && cmd.aliases.includes(command); });
                if (!cmd) return [3 /*break*/, 2];
                console.log("(\u001B[2m".concat((_b = message.guild) === null || _b === void 0 ? void 0 : _b.name, "\u001B[0m) ").concat(message.author.username, " : ").concat(message.content));
